...

{
    ...
    "There is no such task ID": "Es gibt keine solche Task-ID",
    ...
    "Error trying to signin using Google. You will need to give this application access to your email and the email needs to be verified": "Fehler beim Versuch, sich mit Google anzumelden. Sie m\u00fcssen dieser Anwendung Zugriff auf Ihre E-Mail gew\u00e4hren und die E-Mail muss verifiziert werden",
    ...
    "saturday": "Samstag",
    "sunday": "Sonntag",
    "Your activity: <span class=\"notranslate\">{activity}<\/span> ": "Ihre Aktivit\u00e4t: <span class=\"notranslate\">{activity}<\/span>",
    "Task": "Aufgabe",
    "Project": "Projekt",
    "Time": "Zeit",
    "Week": "Woche",
    "Show week": "Woche zeigen",
    ...
    "Your have no projects yet": "Sie haben noch keine Projekte",
