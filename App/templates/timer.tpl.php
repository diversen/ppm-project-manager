<div id="timer" class="timer" style="display:none" >
    <span style="padding:4px; float: left; min-width:80px; " id="timer_display"></span>
    <button id="timer_start" class="button-small" href="#">Start</button>
    <button id="timer_pause" class="button-small" href="#">Pause</button>
...
<script>
    ...
    timer_toggle.addEventListener('click', function (e) {
        console.log(timer_elem.style.display);
    ...
    // Pebble.toggleDisplay(timer_toggle);
